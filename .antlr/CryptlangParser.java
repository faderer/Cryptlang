...
public class CryptlangParser extends Parser {
	...
	public static final int
		...
		T__101=102, T__102=103, T__103=104, NatSpecSingleLine=105, NatSpecMultiLine=106, 
		Int=107, Uint=108, Byte=109, Fixed=110, Ufixed=111, VersionLiteral=112, 
		BooleanLiteral=113, DecimalNumber=114, HexNumber=115, NumberUnit=116, 
		HexLiteral=117, ReservedKeyword=118, AnonymousKeyword=119, BreakKeyword=120, 
		ConstantKeyword=121, ContinueKeyword=122, ExternalKeyword=123, IndexedKeyword=124, 
		InternalKeyword=125, PayableKeyword=126, PrivateKeyword=127, PublicKeyword=128, 
		PureKeyword=129, TypeKeyword=130, ViewKeyword=131, Identifier=132, StringLiteral=133, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'SHA2'", "'RIPEMD'", "'ECDSA'", "'RSA'", "'BLS'", "'Pedersen'", "'Merkle'", 
	...
	public final ContractDefinitionContext contractDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 8444249446478849L) != 0) || ((((_la - 105)) & ~0x3f) == 0 && ((1L << (_la - 105)) & 134217855L) != 0)) {
				{
				{
				setState(286);
				contractPart();
	...
	public final InheritanceSpecifierContext inheritanceSpecifier() throws RecognitionException {
		...
		try {
			...
			if (_la==T__21) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9223369794877636576L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 13220527812380671L) != 0) || ((((_la - 130)) & ~0x3f) == 0 && ((1L << (_la - 130)) & 13L) != 0)) {
					{
					setState(296);
					expressionList();
					}
	...
	public final StateVariableDeclarationContext stateVariableDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 121)) & ~0x3f) == 0 && ((1L << (_la - 121)) & 209L) != 0)) {
				{
				{
				setState(313);
				_la = _input.LA(1);
				if ( !(((((_la - 121)) & ~0x3f) == 0 && ((1L << (_la - 121)) & 209L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final StructDefinitionContext structDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 8444249446055937L) != 0) || ((((_la - 107)) & ~0x3f) == 0 && ((1L << (_la - 107)) & 33554463L) != 0)) {
				{
				setState(338);
				variableDeclaration();
				setState(339);
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 8444249446055937L) != 0) || ((((_la - 107)) & ~0x3f) == 0 && ((1L << (_la - 107)) & 33554463L) != 0)) {
					{
					{
					setState(340);
					variableDeclaration();
	...
	public final ModifierListContext modifierList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__13 || _la==T__40 || ((((_la - 121)) & ~0x3f) == 0 && ((1L << (_la - 121)) & 3573L) != 0)) {
				{
				setState(397);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final StateMutabilityContext stateMutability() throws RecognitionException {
		...
		try {
			...
			setState(544);
			_la = _input.LA(1);
			if ( !(((((_la - 121)) & ~0x3f) == 0 && ((1L << (_la - 121)) & 1313L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ElementaryTypeNameContext elementaryTypeName() throws RecognitionException {
		...
		try {
			...
			setState(768);
			_la = _input.LA(1);
			if ( !(_la==T__34 || _la==T__62 || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 272678883688455L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						setState(794);
						_la = _input.LA(1);
						if ( !(_la==T__12 || _la==T__75 || _la==T__76) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					...
					case 13:
						...
						setState(830);
						_la = _input.LA(1);
						if ( !(_la==T__9 || ((((_la - 88)) & ~0x3f) == 0 && ((1L << (_la - 88)) & 1023L) != 0)) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final AssemblyBlockContext assemblyBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 4593759717198083L) != 0) || ((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 51561299981L) != 0)) {
				{
				{
				setState(909);
				assemblyItem();
	...
	public final AssemblyCallContext assemblyCall() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 4573968507863041L) != 0) || ((((_la - 114)) & ~0x3f) == 0 && ((1L << (_la - 114)) & 786443L) != 0)) {
					{
					setState(947);
					assemblyExpression();
					}
	...
	public final AssemblyLiteralContext assemblyLiteral() throws RecognitionException {
		...
		try {
			...
			setState(1038);
			_la = _input.LA(1);
			if ( !(((((_la - 114)) & ~0x3f) == 0 && ((1L << (_la - 114)) & 524299L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
